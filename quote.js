...
// retirer variable roughTotal
// changer total_ pour elevTotal
//ajout d'une ligne de code
//retrait de roughTotal
...
//ajout du champs #numElev_2
    function emptyElevatorsNumberAndPricesFields() {
        $('#numElev_2').val('');
        $('#numElev_3').val('');
        $('.priceField').val('');
    };
//ajout de virgule projectType
    ...
    //changer corporate pour commercial
    //ajout section hybrid et ajustement des id
    function doCalc() {
